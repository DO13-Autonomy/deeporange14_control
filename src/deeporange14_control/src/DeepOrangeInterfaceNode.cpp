...
int main(int argc, char **argv) {
  ...
  //deeporange14::DeepOrangeStateSupervisor deeporange_stateSupervisor(node, priv_nh);
  //deeporange14::VelocityController deeporange_velocityController(node, priv_nh);

  // create Data Logger object
  //deeporange14::DataLogger deeporange_datalogger(node, priv_nh);
  deeporange14::DeepOrangeDbwCan deeporange_canNode(node);//, priv_nh);
